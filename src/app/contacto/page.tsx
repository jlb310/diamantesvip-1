    ...
    <div className="min-h-screen bg-surface flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-4">
        ...
        <p className="text-muted-light text-sm text-center max-w-sm mb-10">
          Estamos disponibles para ayudarte. Escríbenos por WhatsApp y te responderemos a la brevedad.
        </p>

        {/* WhatsApp */}
        <a
          href="https://wa.me/56932508878?text=Hola%20Diamantes%20VIP,%20quiero%20información"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 text-white font-bold py-4 px-8 rounded-2xl transition-all hover:scale-[1.02] shadow-lg mb-6"
        ...
        <p className="text-muted-light text-xs mb-12">+56 9 3250 8878</p>
